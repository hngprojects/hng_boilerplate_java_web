...
import hng_java_boilerplate.sale.service.saleServiceImpl.SaleServiceImpl;
...
public class SaleController {
    ...
    private final SaleServiceImpl salesService;

    public SaleController(SaleServiceImpl salesService) {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Summary data not found", content = @Content(schema = @Schema(implementation = ResponseDTO.class))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Error fetching pie chart data", content = @Content(schema = @Schema(implementation = ResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "User not Authorized", content = @Content(schema = @Schema(implementation = UserNotFoundException.class))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Error fetching bar chart data", content = @Content(schema = @Schema(implementation = ResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "User not Authorized", content = @Content(schema = @Schema(implementation = UserNotFoundException.class))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Error fetching line chart data", content = @Content(schema = @Schema(implementation = ResponseDTO.class))),
            @ApiResponse(responseCode = "401", description = "User not Authorized", content = @Content(schema = @Schema(implementation = UserNotFoundException.class))),
