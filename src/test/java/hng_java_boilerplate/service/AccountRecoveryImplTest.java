...
public class AccountRecoveryImplTest {
    ...
    public void setUp() {
        ...
        when(authentication.getPrincipal()).thenReturn("mockUsername");
    ...
    public void testSubmitSecurityQuestions_Success() {
        ...
        SubmitSecurityQuestionsRequest request = new SubmitSecurityQuestionsRequest(List.of(answer1, answer2, answer3));
        User user = new User();
        when(userRepository.findById(any())).thenReturn(Optional.of(user));
    ...
    public void testDeleteRecoveryOptions_Success() {
        ...
        request.setOptions(List.of("email", "phone_number"));
        User user = new User();
        when(userRepository.findById(any())).thenReturn(Optional.of(user));
