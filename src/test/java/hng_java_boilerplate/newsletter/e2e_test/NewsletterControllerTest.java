...
public class NewsletterControllerTest {
    ...
    public void testJoinNewsletter() throws Exception {
        NewsletterEmailRequestDto subscriptionEmailRequestDto = new NewsletterEmailRequestDto("test7@gmail.com");

        mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/pages/newsletter")
